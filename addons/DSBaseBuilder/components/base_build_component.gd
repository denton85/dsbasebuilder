...
## This defines the component type this is, so connections know whether to activate (ie, Connections that accept Walls should accept this if the type is specified as "Wall")
